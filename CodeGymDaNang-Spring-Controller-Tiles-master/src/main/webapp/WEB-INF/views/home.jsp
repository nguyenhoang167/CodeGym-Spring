...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
    ...
    <div class="client-logos my-5">
        <div class="container text-center">
            <img src="<c:url value="/resources/images/client-logos.png" />" alt="client logos" class="img-fluid">
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="perspective-phone">
                <img src="<c:url value="/resources/images/perspective.png" />" alt="perspective phone" class="img-fluid">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="<c:url value="/resources/images/graphic.png" />" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                        <div>
    ...
    <div class="section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="<c:url value="/resources/images/dualphone.png" />" alt="dual phone" class="img-fluid">
                </div>
    ...
    <div class="section light-bg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="<c:url value="/resources/images/iphonex.png" />" alt="iphone" class="img-fluid">
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonials owl-carousel">
                <div class="testimonials-single">
                    <img src="<c:url value="/resources/images/client.png" />" alt="client" class="client-img"/>
    ...
    <div class="section light-bg" id="gallery">
        <div class="container">
            ...
            <div class="img-gallery owl-carousel owl-theme">
                <img src="<c:url value="/resources/images/screen1.jpg" />" alt="image"/>
                <img src="<c:url value="/resources/images/screen2.jpg" />" alt="image"/>
                <img src="<c:url value="/resources/images/screen3.jpg" />" alt="image"/>
                <img src="<c:url value="/resources/images/screen1.jpg" />" alt="image"/>
            </div>
        ...
        <div class="container">
            <div class="call-to-action">
                ...
                <div class="my-4">
                    ...
                    <a href="#" class="btn btn-light"><img src="<c:url value="/resources/images/appleicon.png" />" alt="icon"/> App Store</a>
                    <a href="#" class="btn btn-light"><img src="<c:url value="/resources/images/playicon.png" />" alt="icon"/> Google play</a>
                </div>
